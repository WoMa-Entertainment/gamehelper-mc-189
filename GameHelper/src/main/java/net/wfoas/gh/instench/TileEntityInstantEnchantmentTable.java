...
public class TileEntityInstantEnchantmentTable extends TileEntity implements ITickable, IInteractionObject {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "gamehelper.container.instant_enchantment_table";
	}
	...
	public String getGuiID() {
		return "minecraft:enchantment_altar";
	}
}