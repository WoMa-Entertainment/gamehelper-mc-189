...
public class BigInventoryItem implements IInventory {
	 ...
	 */
	public BigInventoryItem(ItemStack stack, EntityPlayer pe) {
		this.pe = pe;
		uuID = "";
		itemStack = stack;
		invItem = stack;
		...
		if (!stack.hasTagCompound()) {
			...
			stack.getTagCompound().setString("OwnerName", pe.getName());
