...
public class UltraInventoryItem implements IInventory {
	...
	public static final int INV_SIZE = 84;
	 ...
	 */
	public UltraInventoryItem(ItemStack stack, EntityPlayer ep) {
		this.ep = ep;
		uuID = "";
		itemStack = stack;
		invItem = stack;
		...
		if (!stack.hasTagCompound()) {
			...
			stack.getTagCompound().setLong("OwnerMSB", ep.getUniqueID().getMostSignificantBits());
			stack.getTagCompound().setLong("OwnerLSB", ep.getUniqueID().getLeastSignificantBits());
	...
	public void openInventory(EntityPlayer player) {
		// if (!hasOwner) {
		// invItem.getTagCompound().setLong("OwnerMSB",
		// player.getUniqueID().getMostSignificantBits());
		// invItem.getTagCompound().setLong("OwnerLSB",
