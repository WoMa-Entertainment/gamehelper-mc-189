...
public class EntityShotPotion extends EntityThrowable {
	/**
	 * The damage value of the thrown potion that this EntityPotion represents.
	 */
	private ItemStack potionDamage;
	protected float velo = 0.5f;

	public EntityShotPotion(World worldIn) {
		super(worldIn);
		System.out.println("called on the " + (worldIn.isRemote ? "Client" : "Server") + " Site");
	}

	public EntityShotPotion(World worldIn, float velocity) {
		super(worldIn);
		this.velo = velocity;
	}

	public EntityShotPotion(World worldIn, EntityLivingBase throwerIn, int meta, float velocity) {
		this(worldIn, throwerIn, new ItemStack(Items.potionitem, 1, meta), velocity);
	}

	public EntityShotPotion(World worldIn, EntityLivingBase throwerIn, ItemStack potionDamageIn, float velocity) {
	...
	public EntityShotPotion(World worldIn, double x, double y, double z, int p_i1791_8_) {
		this(worldIn, x, y, z, new ItemStack(Items.potionitem, 1, p_i1791_8_));
	}

	public EntityShotPotion(World worldIn, double x, double y, double z, ItemStack potionDamageIn) {
		super(worldIn, x, y, z);
		this.potionDamage = potionDamageIn;
		// this.velo = velocity;
	}
