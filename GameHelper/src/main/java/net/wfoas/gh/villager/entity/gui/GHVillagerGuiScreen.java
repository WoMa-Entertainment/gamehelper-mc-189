package net.wfoas.gh.villager.entity.gui;
...
public class GHVillagerGuiScreen extends GuiContainer {
	...
	private GHVillagerGuiScreen.MerchantButton nextButton;
	/** Returns to the previous Merchant recipe if one is applicable. */
	private GHVillagerGuiScreen.MerchantButton previousButton;
	/**
	...
	public GHVillagerGuiScreen(InventoryPlayer p_i45500_1_, IMerchant p_i45500_2_, World worldIn) {
	...
	public void initGui() {
		...
		this.buttonList
				.add(this.nextButton = new GHVillagerGuiScreen.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
		this.buttonList
				.add(this.previousButton = new GHVillagerGuiScreen.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
	...
	static class MerchantButton extends GuiButton {
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY) {
			if (this.visible) {
				mc.getTextureManager().bindTexture(GHVillagerGuiScreen.MERCHANT_GUI_TEXTURE);
				GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
