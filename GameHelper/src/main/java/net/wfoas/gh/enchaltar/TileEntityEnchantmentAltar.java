...
public class TileEntityEnchantmentAltar extends TileEntity implements ITickable, IInteractionObject {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.enchantmentaltar";
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new EnchantmentAltarContainer(playerInventory, getPos());
	}

	@Override
	public String getGuiID() {
		return "gamehelper:enchantment_altar";
	}
}