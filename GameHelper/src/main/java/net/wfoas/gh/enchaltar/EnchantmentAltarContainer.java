...
public class EnchantmentAltarContainer extends Container {
	...
	public EnchantmentAltarContainer(InventoryPlayer playerInv) {
		this(playerInv, BlockPos.ORIGIN);
	}

	public EnchantmentAltarContainer(InventoryPlayer playerInv, BlockPos pos) {
		entityPlayer = playerInv.player;
		this.tableInventory = new InventoryBasic("EnchantAltar", true, 2) {
			...
			public void markDirty() {
				super.markDirty();
				EnchantmentAltarContainer.this.onCraftMatrixChanged(this);
			}
		};
