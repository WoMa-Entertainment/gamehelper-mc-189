...
public final class ASMHelper {
	 ...
	 * @param cwFlags
	 *            the flags to be supplied to the ClassWriter. You almost always
	 *            want both COMPUTE_FRAMES and COMPUTE_MAXS
	 * @return a byte array representation of the ClassNode to be written back
	 *         to the ClassLoader
	 */
...
//		// ManPackLoadingPlugin.MOD_LOG.log(Level.INFO, String.format("Class %s
//		// successfully transformed!", cnode.name));
//		return bArr;
//	}
//
//	/**
...
//
//	/**
//	 * Searches for the instruction set (needle) inside an another instruction
//	 * set (haystack) and returns the first instruction node from the found
//	 * needle.
//	 *
//	 * @param haystack
...
//	 * @return The first instruction node from the haystack on the found
//	 *         position
//	 * @throws de.sanandrew.core.manpack.transformer.ASMHelper.InvalidNeedleException
...
//	/**
//	 * Searches for the instruction set (needle) inside an another instruction
//	 * set (haystack) and returns the last instruction node from the found
//	 * needle.
//	 *
//	 * @param haystack
//	 *            The instruction set to be searched in
...
//	 * @return true, if the name was found, or else false
//	 * @throws de.sanandrew.core.manpack.transformer.ASMHelper.MethodNotFoundException
...
//
//	/**
//	 * Gets the appropriate field/method name for either it is called in a
//	 * development or productive environment
//	 *
//	 * @param mcp
...
//
//	/**
//	 * Writes the class bytes into a file. Helpful for debugging ASM
//	 * transformations.<br>
//	 * Note: this will write the bytes as compiled .class file! Use JD-GUI to
//	 * look into the class.
//	 *
//	 * @param classBytes
...
//		Triplet<String, String, String[]> methodDesc = ASMNames.getSrgNameMd(method);
//
//		return new MethodInsnNode(opcode, methodDesc.getValue0(), methodDesc.getValue1(), methodDesc.getValue2()[0],
//				intf);
//	}
//
...
//			super(count > 1 ? "Multiple Needles found in Haystack!"
//					: count < 1 ? "Needle not found in Haystack!" : "Wait, Needle was found!? o.O");
//		}
//	}
//
...
//			super(String.format("Could not find any method matching the name < %s > and description < %s >", methodName,
//					methodDesc));
//		}
//	}
}