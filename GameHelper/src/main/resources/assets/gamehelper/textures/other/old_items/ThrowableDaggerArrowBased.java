...
public class ThrowableDaggerArrowBased {
...
//	private double damage = IronDagger.getDamageIron();
...
//	this.saveItemStackToEntityData(new ItemStack(GameHelper.IRON_DAGGER));
//}
//
...
//}
//
//public ThrowableDagger(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_,
//		float p_i1755_5_) {
//	super(worldIn);
//	this.saveItemStackToEntityData(new ItemStack(GameHelper.IRON_DAGGER));
//	this.renderDistanceWeight = 10.0D;
...
//}
//
//public ThrowableDagger(World worldIn, EntityLivingBase shooter, float p_i1756_3_) {
//	super(worldIn);
//	this.renderDistanceWeight = 10.0D;
//	this.shootingEntity = shooter;
//	this.saveItemStackToEntityData(new ItemStack(GameHelper.IRON_DAGGER));
...
//
//	public void saveItemStackToEntityData(ItemStack is) {
//		thrownItem = is;
//		System.out.println("SavedItemStack");
//		System.out.println(thrownItem.writeToNBT(new NBTTagCompound()).toString());
//	}
//
...
//		for (int i = 0; i < 4; ++i) {
//			float f4 = 0.25F;
//			this.worldObj.spawnParticle(EnumParticleTypes.CRIT, this.posX - this.motionX * (double) f4,
...
//						damagesource = new DamageSourceDagger(this);
//					} else {
//						damagesource = new DamageSourceDagger(this.shootingEntity, this);
//					}
//
...
//
//			if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(thrownItem)) {
//				flag = false;
//			}
//
//			if (flag) {
...
//	for (int i = 0; i < 4; ++i) {
//		float f4 = 0.25F;
//		this.worldObj.spawnParticle(EnumParticleTypes.CRIT_MAGIC, this.posX - this.motionX * (double) f4,
//				this.posY - this.motionY * (double) f4, this.posZ - this.motionZ * (double) f4, this.motionX,
//				this.motionY, this.motionZ, new int[0]);
//	}
//	if (p_70184_1_.typeOfHit == MovingObjectType.BLOCK) {
//		GameHelper.dropItem(thrownItem, new LocationA(p_70184_1_.hitVec, this.worldObj));
//	}
}