...
public class GameHelperHorseTransformer implements IClassTransformer {
...
//		ASMHelper.writeClassToFile(bytes, "F:\\fmldev189\\EntityHorse_ASM.class");
...
//		} else {
//			// ManPackLoadingPlugin.MOD_LOG.log(Level.INFO, "Running on
//			// dedicated server, no need to transform Method
//			// >setHorseTexturePaths< in EntityHorse!");
//		}
//
...
//		newInstr.add(
//				ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MD_ANIMALCHEST_GET_STACK_IN_SLOT, false));
