...
import net.wfoas.gh.blocks.Purerose;
import net.wfoas.gh.blocks.Pureturquoise;
import net.wfoas.gh.blocks.Pureviolet;
...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent event, GameHelper gh) {
		...
		GameHelperCoreModule.Purerose = new Purerose();
