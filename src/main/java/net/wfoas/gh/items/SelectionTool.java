...
public class SelectionTool extends GameHelperModItem {

	public SelectionTool() {
		super("gh_selection_tool_1");
	}
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side,
		...
		SelectionProperties.setItem("pos_1_x", pos.getX(), playerMp);
		SelectionProperties.setItem("pos_1_y", pos.getY(), playerMp);
		SelectionProperties.setItem("pos_1_z", pos.getZ(), playerMp);
		playerMp.addChatMessage(new ChatComponentText(
				ChatColor.LIGHT_PURPLE + "Set position 1 at x=" + SelectionProperties.getItem("pos_1_x", playerMp)
						+ " y=" + SelectionProperties.getItem("pos_1_y", playerMp) + " z="
						+ SelectionProperties.getItem("pos_1_z", playerMp)));
...
//			int selected_blocks = ((lx - sx) == 0 ? 1 : (lx - sx)) * ((ly - sy) == 0 ? 1 : (ly - sy))
//					* ((lz - sz) == 0 ? 1 : (lz - sz));
