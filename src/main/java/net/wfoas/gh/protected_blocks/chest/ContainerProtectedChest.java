...
public class ContainerProtectedChest extends Container {
	private IInventory lowerChestInventory;
	private int numRows;

	public ContainerProtectedChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player) {
