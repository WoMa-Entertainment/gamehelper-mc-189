...
public class ContainerProtectedFurnace extends Container {
	...
	public ContainerProtectedFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (ProtectedFurnaceTileEntity.isItemFuel(itemstack1)) {
