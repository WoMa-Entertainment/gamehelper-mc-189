...
public class ProtectedBrewstand extends BlockContainer implements IGHModBlock, GHModItemUpdater {
	...
	public ItemBrewingStandProtected brew_item;

	public ProtectedBrewstand() {
		super(Material.iron);
		brew_item = new ItemBrewingStandProtected(this);
		GameRegistry.registerBlock(this, ItemBrewingStandProtected.class, brew_item.getName());
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new ProtectedBrewstandTileEntity();
	}
	...
	public String getName() {
		return brew_item.getName();
	}

	@Override
	public void updateInitEvent(CreativeTabs tab) {
		brew_item.updateInitEvent(tab);
