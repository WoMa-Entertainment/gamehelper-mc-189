...
public class ProtectedBrewstandTileEntity extends TileEntityLockable
	...
	private boolean canBrew() {
		return net.minecraftforge.common.brewing.BrewingRecipeRegistry.canBrew(brewingItemStacks, brewingItemStacks[3],
				outputSlots);
	}
	...
	private void brewPotions() {
		if (net.minecraftforge.event.ForgeEventFactory.onPotionAttemptBreaw(brewingItemStacks))
			return;
		if (this.canBrew()) {
			net.minecraftforge.common.brewing.BrewingRecipeRegistry.brewPotions(brewingItemStacks, brewingItemStacks[3],
					outputSlots);
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		if (index == 3 && net.minecraftforge.common.brewing.BrewingRecipeRegistry.isValidIngredient(stack))
			return true;
		else if (index != 3 && net.minecraftforge.common.brewing.BrewingRecipeRegistry.isValidInput(stack))
			return true;
		return false;
	}
