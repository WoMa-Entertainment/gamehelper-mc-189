...
public class TileEntityInstantEnchantmentTableRenderer extends TileEntitySpecialRenderer {
	...
	public void func_180537_a(TileEntityInstantEnchantmentTable p_180537_1_, double p_180537_2_, double p_180537_4_,
		...
		float f1 = p_180537_1_.tickCount + p_180537_8_;
		GlStateManager.translate(0.0F, 0.1F + MathHelper.sin(f1 * 0.1F) * 0.01F, 0.0F);
		float f2;

		for (f2 = p_180537_1_.bookRotation
				- p_180537_1_.bookRotationPrev; f2 >= (float) Math.PI; f2 -= ((float) Math.PI * 2F)) {
			;
		}
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double posX, double posZ, double p_180535_6_,
		...
		this.func_180537_a((TileEntityInstantEnchantmentTable) p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
}