...
public class GuiItemInventory extends GuiContainer {
	...
	private static final ResourceLocation iconLocation = new ResourceLocation("gamehelper",
			"gui/container/tiny_backpack.png");
	...
	public void initGui() {
		super.initGui();
		b1 = new GuiButton(1, this.guiLeft + 174, this.guiTop + 27, 16, 16, I18n.format("button.gamehelper.backpack.private"));
		b2 = new GuiButton(2, this.guiLeft + 174, this.guiTop + 16 + 27, 16, 16, I18n.format("button.gamehelper.backpack.public"));
