...
public class GuiContainerEnchantmentTable extends GuiContainer {
	...
	private ContainerEnchantmentTable container;
	...
	public GuiContainerEnchantmentTable(InventoryPlayer inventory, World worldIn, IWorldNameable p_i45502_3_,
			int enchantmentpower, int x, int y, int z) {
		super(new ContainerEnchantmentTable(inventory, worldIn, enchantmentpower, x, y, z));
		this.playerInventory = inventory;
		this.container = (ContainerEnchantmentTable) this.inventorySlots;
