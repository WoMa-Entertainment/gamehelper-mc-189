...
public class GuiContainerAnvil extends GuiContainer implements ICrafting {
	private static final ResourceLocation anvilResource = new ResourceLocation("textures/gui/container/anvil.png");
	private ContainerAnvil anvil;
	private GuiTextField nameField;
	private InventoryPlayer playerInventory;

	public GuiContainerAnvil(InventoryPlayer p_i45508_1_, World worldIn) {
		super(new ContainerAnvil(p_i45508_1_, worldIn, Minecraft.getMinecraft().thePlayer));
		this.playerInventory = p_i45508_1_;
		this.anvil = (ContainerAnvil) this.inventorySlots;
	}
