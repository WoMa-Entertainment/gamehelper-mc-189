...
public class EnchantmentAltar extends GameHelperModBlock implements ITileEntityProvider {
	public EnchantmentAltar() {
		super(Material.rock, "enchantment_altar");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityEnchantmentAltar();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.isRemote) {
			...
			if (tileentity instanceof TileEntityEnchantmentAltar) {
				playerIn.openGui(GameHelper.instance, EnchantmentAltarGui.GUI_ID, playerIn.worldObj, pos.getX(), pos.getY(), pos.getZ());
			}
			// WorldProvider wp =
