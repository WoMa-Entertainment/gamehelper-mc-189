...
import net.wfoas.gh.blocks.BodenEBA;
import net.wfoas.gh.blocks.BodenEBA2;
import net.wfoas.gh.blocks.BodenEBA3;
import net.wfoas.gh.blocks.BodenEBA4;
import net.wfoas.gh.blocks.BodenEBA5;
import net.wfoas.gh.blocks.DieleEBA;
import net.wfoas.gh.blocks.DieleEBA2;
import net.wfoas.gh.blocks.DieleEBA3;
...
import net.wfoas.gh.blocks.GarageEBA;
import net.wfoas.gh.blocks.GarageEBA2;
import net.wfoas.gh.blocks.GarageEBA3;
import net.wfoas.gh.blocks.IGHModBlock;
import net.wfoas.gh.blocks.No_texture_block;
import net.wfoas.gh.blocks.ParkschildEBA;
...
import net.wfoas.gh.blocks.SteinEBA;
...
import net.wfoas.gh.blocks.WandEBA;
...
import net.wfoas.gh.thermalinventory.armor.GameHelperCoolingBootsItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperCoolingChestplateItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperCoolingHelmetItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperCoolingLeggingsItem;
...
import net.wfoas.gh.thermalinventory.armor.GameHelperWarmingBootsItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperWarmingChestplateItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperWarmingHelmetItem;
import net.wfoas.gh.thermalinventory.armor.GameHelperWarmingLeggingsItem;
...
public class GameHelperCoreModule extends GameHelperModuleAbstract {
	...
	public static GameHelperModBlock GarageEBA;
	public static GameHelperModBlock SteinEBA;
	public static GameHelperModBlock BodenEBA5;
	public static GameHelperModBlock BodenEBA4;
	public static GameHelperModBlock BodenEBA3;
	public static GameHelperModBlock BodenEBA2;
	public static GameHelperModBlock BodenEBA;
	public static GameHelperModBlock DieleEBA3;
	...
	public void registerTab() {
		...
		ParkschildEBA.updateInitEvent(TAB_GAMEHELPER);
		WandEBA.updateInitEvent(TAB_GAMEHELPER);
		GarageEBA3.updateInitEvent(TAB_GAMEHELPER);
		GarageEBA2.updateInitEvent(TAB_GAMEHELPER);
		GarageEBA.updateInitEvent(TAB_GAMEHELPER);
		SteinEBA.updateInitEvent(TAB_GAMEHELPER);
		BodenEBA5.updateInitEvent(TAB_GAMEHELPER);
		BodenEBA4.updateInitEvent(TAB_GAMEHELPER);
		BodenEBA3.updateInitEvent(TAB_GAMEHELPER);
		BodenEBA2.updateInitEvent(TAB_GAMEHELPER);
		BodenEBA.updateInitEvent(TAB_GAMEHELPER);
		DieleEBA3.updateInitEvent(TAB_GAMEHELPER);
		DieleEBA2.updateInitEvent(TAB_GAMEHELPER);
		DieleEBA.updateInitEvent(TAB_GAMEHELPER);
	...
	public void preInitServer(FMLPreInitializationEvent event) {
		...
		GameHelperCoreModule.WARMING_ALLR_BOOTS = new GameHelperWarmingBootsItem();
		GameHelperCoreModule.WARMING_ALLR_CHEST = new GameHelperWarmingChestplateItem();
		GameHelperCoreModule.WARMING_ALLR_HELMET = new GameHelperWarmingHelmetItem();
		GameHelperCoreModule.WARMING_ALLR_LEGGINGS = new GameHelperWarmingLeggingsItem();
		GameHelperCoreModule.COOLING_ALLR_BOOTS = new GameHelperCoolingBootsItem();
		GameHelperCoreModule.COOLING_ALLR_CHEST = new GameHelperCoolingChestplateItem();
		GameHelperCoreModule.COOLING_ALLR_HELMET = new GameHelperCoolingHelmetItem();
		GameHelperCoreModule.COOLING_ALLR_LEGGINGS = new GameHelperCoolingLeggingsItem();
		...
		GameHelperCoreModule.ParkschildEBA = new ParkschildEBA();
		GameHelperCoreModule.WandEBA = new WandEBA();
		GameHelperCoreModule.GarageEBA3 = new GarageEBA3();
		GameHelperCoreModule.GarageEBA2 = new GarageEBA2();
		GameHelperCoreModule.GarageEBA = new GarageEBA();
		GameHelperCoreModule.SteinEBA = new SteinEBA();
		GameHelperCoreModule.BodenEBA5 = new BodenEBA5();
		GameHelperCoreModule.BodenEBA4 = new BodenEBA4();
		GameHelperCoreModule.BodenEBA3 = new BodenEBA3();
		GameHelperCoreModule.BodenEBA2 = new BodenEBA2();
		GameHelperCoreModule.BodenEBA = new BodenEBA();
		GameHelperCoreModule.DieleEBA2 = new DieleEBA2();
		GameHelperCoreModule.DieleEBA3 = new DieleEBA3();
		GameHelperCoreModule.DieleEBA = new DieleEBA();
