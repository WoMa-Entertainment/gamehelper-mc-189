 ...
 * {@link #charge} contains the value for how much the player had charged before
 * stopping the shot.<br>
 * <br>
 ...
 **/
@Cancelable
public class PotionLooseEvent extends PlayerEvent {
	public final ItemStack bow;
	public int charge;

	public PotionLooseEvent(EntityPlayer player, ItemStack bow, int charge) {
		super(player);
		this.bow = bow;
		this.charge = charge;
	}
